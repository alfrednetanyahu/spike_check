...
while i <len(line):
    ...
    if rr_0.bits[0]==True:
        ...
        ll=line[i]
        ll_split=ll.split()
        print "X fid: ", ll_split[1]
        if 100*float(ll_split[1])<0:
            x=(int(offset[0]))-int(100*float(ll_split[1])*(5835/5820))
        elif 100*float(ll_split[1])>0:
            x=(int(offset[0]))-int(100*float(ll_split[1])*(5820/5835))
