...
while process==True:
    ...
    if rr.bits[0]==True:
        ...
        #print x_ref,y_ref,x_site,y_site, "DETERMINED VALUES"
        #print x_t,y_t,z, "CAMERA POSITON SENT first"
        ...
        print "POSITON 1: EVALUATING BOOLEAN"
        ...
        #When both x_ref and x-or are in but y_coordinates are out.    
            ...
            if ((x_upperlimit - x_ref) < (x_ref + x_lowerlimit)):
        ...
        print  "POSITON 2: SAVE SITE COORDINATES "        
        x_ref = x_site
        y_ref = y_site

        print x_ref, y_ref, " NEW VALUES"
        ...
        while cam==1:
            ...
            if rr.bits[0]==True:
               ...
               # Capture frame-by-frame
                ...
                print x,y,z, "PIN POSITON SENT second"
                if x>32767:
                    if x>65534:
                        x1=32767
                        x2=32767
        ...
        while i <= position_lines:
            while j <=pin_lines:
                ...
                if rr.bits[0]==True:
                    ...
                    print "POSITION 3 : SAVE SITE COORDINATES"
                    x_ref = x_site
                    y_ref = y_site

                    print x_ref, y_ref, "VALUES"
                    ...
                    while cam==1:
                        ...
                        if rr.bits[0]==True:
                           ...
                           # Capture frame-by-frame
                            ...
                            print x,y,z, "PIN POSITON (2) SENT second"
                            if x>32767:
                                if x>65534:
                                    x1=32767
                                    x2=32767
